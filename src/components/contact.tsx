...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    emailjs.send(
      "service_gypppne",   // ✅ Your Service ID
      "template_c77uui6",  // ✅ Your Template ID
      {
      ...
      "PZ07evvrtv9VxPgwu"  // ✅ Your Public Key
    )
    .then(
      (result) => {
  ...
  const socialLinks = [
    { icon: Github, href: 'https://github.com/asurax1983', label: 'GitHub', color: 'hover:text-gray-300' },
    { icon: Linkedin, href: 'https://www.linkedin.com/in/habibi-s-4b7266377', label: 'LinkedIn', color: 'hover:text-blue-400' },
    { icon: Instagram, href: 'https://www.instagram.com/asurax_studios?igsh=MTI5Ynh0cGo0anM1dA==', label: 'Instagram', color: 'hover:text-pink-400' },
    { icon: Twitter, href: 'https://twitter.com/your_actual_handle', label: 'Twitter', color: 'hover:text-blue-400' }
  ]
            ...
            {!mounted ? (
              <div className="space-y-6 opacity-0" aria-hidden>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div><div className="w-full h-12 bg-dark-300 rounded-lg" /></div>
                  <div><div className="w-full h-12 bg-dark-300 rounded-lg" /></div>
                </div>
